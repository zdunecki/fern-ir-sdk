...
exports.ExampleTypeShape = core.serialization
    ...
    union: core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../..")))).ExampleUnionType; })),
    undiscriminatedUnion: core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../..")))).ExampleUndiscriminatedUnionType; })),
})
    .transform({
    transform: (value) => {
        switch (value.type) {
